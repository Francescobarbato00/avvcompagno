    ...
    return (
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-red-600 uppercase mb-4 text-sm text-center">Profilo Studio</h2>
          <h1 className="text-5xl font-serif font-bold text-gray-900 mb-12 text-center">
