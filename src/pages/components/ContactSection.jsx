    ...
    return (
      <section className="py-16">
        <div className="container mx-auto">
          <h1 className="text-6xl font-serif font-light text-gray-900 mb-12">Contattaci per una consulenza</h1>
          ...
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="md:w-2/3">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="bg-red-600 text-white py-3 px-8 text-sm uppercase font-light hover:bg-red-700 transition-colors"
                >
                  Invia
                </button>
              </form>
